var games = [
    ...
    {name: "Vex 5", path: "games/vex5/index.html"}
];
...
function loadGame(path) {
    ...
    var button1 = document.getElementById('button_yt');
    var button2 = document.getElementById('button_config');
    var button3 = document.getElementById('button_updates');
